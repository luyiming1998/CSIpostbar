...
function JumpPage(page) {
    ...
    if(searchNameVal){
        window.location.href="/myPost/?postTitle="+searchNameVal+"&&page="+page
    }else{
        window.location.href="/myPost/?page="+page
    }
}
...
function searchByPostName(){
	var searchNameVal=$("#SEARCH_POST_NAME").val().trim();
	window.location.href="/myPost/?postTitle="+searchNameVal
}

function post_detailed(postUUID){
	window.location.replace("/comment/?page=myPost&post_id="+postUUID);

	// window.location.replace("/comment/page=myPost&postid="+postUUID);
