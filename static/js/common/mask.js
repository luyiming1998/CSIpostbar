function ajaxLoading(msg,msgMaginTop){
	...
	$("<div class=\"datagrid-mask-msg\"><img src=\" static/css/default/images/pagination_loading.gif \" width='50px' height='50px'/></div>").html(_msg).appendTo("body").css({display:"block",left:($(document.body).outerWidth(true) ) / 2,top:(document.body.offsetHeight + _msgMaginTop) / 2});
}
