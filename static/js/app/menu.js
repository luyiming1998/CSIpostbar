...
function loadMenu(role){
	var json="";
	if(role===1){
		json='[{"id": "1","name": "贴吧","icon": "","url": "","parentId": "","childs": [{"id": "11","name": "所有文章","icon": "/xingxing.png","url": "/posts/","parentId": "4","childs": []},{"id": "12","name": "我的文章","icon": "/xingxing.png","url": "/myPost/","parentId": "4","childs": []},{"id": "14","name": "我的评论","icon": "/xingxing.png","url": "/myComment/","parentId": "4","childs": []},{"id": "15","name": "语音设置","icon": "/xingxing.png","url": "/audioSet/","parentId": "4","childs": []},{"id": "16","name": "个人设置","icon": "/xingxing.png","url": "/perSet/","parentId": "4","childs": []},{"id": "17","name": "上传头像","icon": "/xingxing.png","url": "/uploadHead/","parentId": "4","childs": []},{"id": "18","name": "用户管理","icon": "/xingxing.png","url": "/userManage/","parentId": "4","childs": []}]}]';
	}else {
		json = '[{"id": "1","name": "贴吧","icon": "","url": "","parentId": "","childs": [{"id": "11","name": "所有文章","icon": "/xingxing.png","url": "/posts/","parentId": "4","childs": []},{"id": "12","name": "我的文章","icon": "/xingxing.png","url": "/myPost/","parentId": "4","childs": []},{"id": "14","name": "我的评论","icon": "/xingxing.png","url": "/myComment/","parentId": "4","childs": []},{"id": "15","name": "语音设置","icon": "/xingxing.png","url": "/audioSet/","parentId": "4","childs": []},{"id": "16","name": "个人设置","icon": "/xingxing.png","url": "/perSet/","parentId": "4","childs": []},{"id": "17","name": "上传头像","icon": "/xingxing.png","url": "/uploadHead/","parentId": "4","childs": []}]}]';
	}// jquery的方法
